...
#define RTIPC_LOG(priority, format, ...)  rtipc_log(priority, \
                                        __FILE__, LOG_STRINGIFY(__LINE__), \
                                        __func__, format "\n", ##__VA_ARGS__)


#define LOG_ERR(format, ...)  RTIPC_LOG(LOG_LEVEL_ERR, format, ##__VA_ARGS__)
#define LOG_WRN(format, ...)   RTIPC_LOG(LOG_LEVEL_WRN, format, ##__VA_ARGS__)
#define LOG_INF(format, ...)   RTIPC_LOG(LOG_LEVEL_INF, format, ##__VA_ARGS__)
#define LOG_DBG(format, ...)  RTIPC_LOG(LOG_LEVEL_DBG, format, ##__VA_ARGS__)
