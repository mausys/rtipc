 ...
 */
ri_consumerq_t* ri_rtipc_take_consumer(const ri_rtipc_t *rtipc, unsigned index);
 ...
 */
ri_producerq_t* ri_rtipc_take_producer(const ri_rtipc_t *rtipc, unsigned index);
